...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Nyumba Furniture" },
      { name: "description", content: "How Nyumba Furniture collects, uses, and protects your information." },
...
function Privacy() {
  return (
    <>
      <PageHero eyebrow="Legal" title="Privacy Policy" description="This page is maintained by Nyumba Furniture and describes how we handle your information." />
      <article className="container-x pb-24 max-w-3xl prose-style">
        ...
        <Block t="Your rights">You may request a copy of your data or its deletion by emailing hello@nyumba.co.ke.</Block>
      </article>
    </>
  );
}
